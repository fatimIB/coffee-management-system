...
class AnalyticsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCardMetrics = channel.unary_unary(
                ...
                request_serializer=analytics__pb2.MonthRequest.SerializeToString,
                response_deserializer=analytics__pb2.CardMetrics.FromString,
                _registered_method=True)
        self.GetOverviewAnalytics = channel.unary_unary(
                '/analytics.AnalyticsService/GetOverviewAnalytics',
                request_serializer=analytics__pb2.MonthRequest.SerializeToString,
                response_deserializer=analytics__pb2.OverviewAnalytics.FromString,
                _registered_method=True)
        self.GetPredictions = channel.unary_unary(
                '/analytics.AnalyticsService/GetPredictions',
                request_serializer=analytics__pb2.PredictionRequest.SerializeToString,
                response_deserializer=analytics__pb2.PredictionResponse.FromString,
                _registered_method=True)
...
def add_AnalyticsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCardMetrics': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=analytics__pb2.MonthRequest.FromString,
                    response_serializer=analytics__pb2.CardMetrics.SerializeToString,
            ),
            'GetOverviewAnalytics': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOverviewAnalytics,
                    request_deserializer=analytics__pb2.MonthRequest.FromString,
                    response_serializer=analytics__pb2.OverviewAnalytics.SerializeToString,
            ),
            'GetPredictions': grpc.unary_unary_rpc_method_handler(
                    servicer.GetPredictions,
                    request_deserializer=analytics__pb2.PredictionRequest.FromString,
                    response_serializer=analytics__pb2.PredictionResponse.SerializeToString,
            ),
    }
...
class AnalyticsService(object):
    ...
    def GetCardMetrics(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analytics.AnalyticsService/GetCardMetrics',
            analytics__pb2.MonthRequest.SerializeToString,
            analytics__pb2.CardMetrics.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetOverviewAnalytics(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/analytics.AnalyticsService/GetOverviewAnalytics',
            analytics__pb2.MonthRequest.SerializeToString,
            analytics__pb2.OverviewAnalytics.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetPredictions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analytics.AnalyticsService/GetPredictions',
            analytics__pb2.PredictionRequest.SerializeToString,
            analytics__pb2.PredictionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
